<template>
  <div class="app-container">
    ...
    >
      <el-table-column align="center" label="图片名称" prop="title" width="150" />
      <!--      <el-table-column align="center" label="图片" prop="image_url">-->
      <!--        <template slot-scope="scope">-->
      <!--          <img :src="scope.row.image_url" width="40">-->
      <!--        </template>-->
      <!--      </el-table-column>-->
...
import { listOnlineImages } from '@/api/onlineImages'
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      if (this.dataForm.image_url) {
        this.image_url = this.dataForm.image_url
      } else {
        this.image_url = ''
      }
    ...
    handleAvatarSuccess(res, file) {
      ...
      this.dataForm.image_url = this.image_url
    },
